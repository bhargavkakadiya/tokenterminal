...
class TokenTerminal:
    ...
    def _get(self, endpoint, params=None, stream=False):
        ...
        response = self.session.get(
            url, params=params, timeout=30, stream=stream)
    ...
    def get_metric_availability(self, project_id: str):
        """
        Returns the metric availability of a given project. The project_id can be fetched from the v1/projects endpoint.
    ...
    def get_historical_metrics(
        self, project_id, timestamp_granularity="daily", since=""
    ):
        """
    ...
    def get_aggregated_metrics(self, project_id: str):
        """
        Returns aggregated metrics for a given project. The project_id can be fetched from the v1/projects endpoint.
        The data is updated once a day.
